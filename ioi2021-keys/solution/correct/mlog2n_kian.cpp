...
public:
    inline IndexDSBase(int index_limit): index_limit_(index_limit) {
    }
};


/// Performs operations in O(log(n)) time
class IndexSet: public IndexDSBase {
    set<int> s;
public:

    inline IndexSet(int index_limit): IndexDSBase(index_limit) {
    }
...
public:
    ...
    inline IndexMap(int index_limit): IndexDSBase(index_limit) {
    }
